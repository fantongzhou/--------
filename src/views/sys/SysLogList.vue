<template>
  <el-container>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>系统访问日志</el-breadcrumb-item>
    </el-breadcrumb>
      ...
      >
        ...
        >
          <template slot-scope="scope" v-if="scope.row.interfaceParams">
            <el-popover
              v-if="scope.row.interfaceParams.length > 10"
              placement="left-end"
              width="200"
              trigger="hover"
            ...
            >
              <span
                ...
                style="
                  ...
                  overflow: hidden;
                "
                >{{ scope.row.interfaceParams }}</span
              >
            </el-popover>
...
export default {
  ...
  methods: {
    getData() {
      (this.loading = true),
        commonAPI("sysLogList", this.formInline).then((res) => {
          this.loading = false;
    ...
    resetting() {
      //重置
      this.formInline.beginTime = formatDate(
